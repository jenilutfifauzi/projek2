...
$data_masukan = $db -> tampil_data_masukan();
...
<head>
    ...
    <title>Data Masukan/Saran | SITOWIS</title>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Kelola Saran dan Masukan</h4>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title">Data Saran/Masukan</h3>
                            ...
                            <div class="table-responsive">
                                ...
                                <thead>
                                            ...
                                            <?php
                                            $no = 1;
                                            foreach ($data_masukan as $row) {
                                            ?>
                                            <tbody>
                                            <tr>

                                            <td><?php echo $row['id'];?></td>
                                            <td><?php echo $row['masukan'];?></td>
