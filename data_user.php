            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Kelola Data</h4>
                    </div>
                        ...
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                ...
                                <thead>
                                            ...
                                            <td>
                                            <a href ="edit_user.php?id=<?php echo $row['id'];?>&action=edit_user_admin">Edit</a>
                                            <a href ="proses.php?id=<?php echo $row['id']; ?>&action=delete_user" onClick="return confirm('Apakah anda ingin menghapus data buku dengan')" >Delete</a>
                                            </td>
                                            </tr>
                                            <?php 
                                            }
                                        ...
                                        <br>
                                        <div align="right"><a href="tambah_user.php"><button type="button" class="btn btn-primary">Tambah Data</button></a></div>
                                    </div>
                                </div>
                            </div>
                                </table>
